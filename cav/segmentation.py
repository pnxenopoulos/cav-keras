...
class ImageSegmentation():
    ...
    '''
    def __init__(self, discovery_images = None, activations_model = None, n_segments = 10, compactness = 0.1):
        ''' Initialize class
        '''
    ...
    def segment_images(self, n_segments = 10, compactness = 0.1, slic_zero = True):
        ...
        if slic_zero:
            ...
            self.image_segments = slic(self.discovery_images, n_segments = self.n_segments, compactness = self.compactness)
    def resize_segments():
